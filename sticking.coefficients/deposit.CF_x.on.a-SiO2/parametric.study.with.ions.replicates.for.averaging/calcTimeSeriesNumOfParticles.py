...
pipeline.modifiers.append(ExpressionSelectionModifier(expression = 'ParticleType==3 && Position.Z<=38'))
...
pipeline2.modifiers.append(ExpressionSelectionModifier(expression = 'ParticleType==4 && Position.Z<=38'))
